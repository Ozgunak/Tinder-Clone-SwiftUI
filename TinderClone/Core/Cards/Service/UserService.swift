...
struct MockUsers {
    static let users: [UserModel] = [
        UserModel(name: "Charles", age: "26", info: "F1 Driver", imageUrls: ["charles1", "charles2", "charles3"]),
        UserModel(name: "Kelly", age: "35", info: "Model", imageUrls: ["kelly1", "kelly2", "kelly3"]),
        UserModel(name: "Max", age: "26", info: "2 Times WC F1 Driver", imageUrls: ["max1", "max4", "max3"]),
    ]
}
